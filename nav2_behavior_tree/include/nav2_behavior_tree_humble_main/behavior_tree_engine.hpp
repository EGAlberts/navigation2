...
/**
 * @enum nav2_behavior_tree_humble_main::BtStatus
 * @brief An enum class representing BT execution status
 */
enum class BtStatus { SUCCEEDED, FAILED, CANCELED };

/**
 * @class nav2_behavior_tree_humble_main::BehaviorTreeEngine
...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::BehaviorTreeEngine
   ...
   * @return nav2_behavior_tree_humble_main::BtStatus Status of BT execution
   */
  BtStatus run(
    BT::Tree * tree,
