...
#include "nav2_behavior_tree_humble_main/ros_topic_logger.hpp"
#include "hm_nav2_util/lifecycle_node.hpp"
#include "hm_nav2_util/simple_action_server.hpp"
...
{
/**
 * @class nav2_behavior_tree_humble_main::BtActionServer
...
{
public:
  using ActionServer = hm_nav2_util::SimpleActionServer<ActionT>;
  ...
  typedef std::function<void (typename ActionT::Result::SharedPtr,
      nav2_behavior_tree_humble_main::BtStatus)> OnCompletionCallback;

  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::BtActionServer class
   */
  ...
  /**
   * @brief A destructor for nav2_behavior_tree_humble_main::BtActionServer class
   */
  ~BtActionServer();
...
protected:
  ...
  std::unique_ptr<nav2_behavior_tree_humble_main::BehaviorTreeEngine> bt_;
...
#include <nav2_behavior_tree_humble_main/bt_action_server_impl.hpp>  // NOLINT(build/include_order)
