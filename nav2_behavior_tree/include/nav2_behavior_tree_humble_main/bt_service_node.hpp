...
public:
  /**
   * @brief A nav2_behavior_tree_humble_main::BtServiceNode constructor
  ...
  void createROSInterfaces()
  {
    ...
    if (service_new != service_name_ || !service_client_) {
      ...
      service_client_ = std::make_shared<hm_nav2_util::ServiceClient<ServiceT>>(
...
protected:
  ...
  typename hm_nav2_util::ServiceClient<ServiceT>::SharedPtr service_client_;
