...
#include "nav2_behavior_tree_humble_main/bt_action_node.hpp"
#include "hm_nav2_msgs/action/assisted_teleop.hpp"

namespace nav2_behavior_tree_humble_main
{

/**
 * @brief A nav2_behavior_tree_humble_main::BtActionNode class that wraps hm_nav2_msgs::action::AssistedTeleop
 * @note This is an Asynchronous (long-running) node which may return a RUNNING state while executing.
 *       It will re-initialize when halted.
 */
class AssistedTeleopAction : public BtActionNode<hm_nav2_msgs::action::AssistedTeleop>
{
  using Action = hm_nav2_msgs::action::AssistedTeleop;
  using ActionResult = Action::Result;

public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::hm_nav2_msgs::action::AssistedTeleop
