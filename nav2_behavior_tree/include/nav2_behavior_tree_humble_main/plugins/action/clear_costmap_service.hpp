...
/**
 * @brief A nav2_behavior_tree_humble_main::BtServiceNode class that wraps nav2_msgs::srv::ClearEntireCostmap
...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::ClearEntireCostmapService
...
/**
 * @brief A nav2_behavior_tree_humble_main::BtServiceNode class that
...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::ClearCostmapExceptRegionService
   * @param service_node_name Service name this node creates a client for
   * @param conf BT node configuration
   */
...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::ClearCostmapAroundRobotService
   * @param service_node_name Service name this node creates a client for
   * @param conf BT node configuration
   */
