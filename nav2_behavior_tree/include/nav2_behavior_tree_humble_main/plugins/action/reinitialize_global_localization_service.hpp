...
/**
 * @brief A nav2_behavior_tree_humble_main::BtServiceNode class that wraps nav2_msgs::srv::Empty
...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::ReinitializeGlobalLocalizationService
