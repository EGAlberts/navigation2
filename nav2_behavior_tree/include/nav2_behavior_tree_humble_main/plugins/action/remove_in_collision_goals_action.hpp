...
#include "nav2_behavior_tree_humble_main/bt_service_node.hpp"
...
/**
 * @brief A nav2_behavior_tree_humble_main::BtServiceNode class that removes goals that are in collision in on the global costmap
...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::RemoveInCollisionGoals
  ...
  static BT::PortsList providedPorts()
  {
    ...
    BT::RegisterJsonDefinition<hm_nav2_msgs::msg::WaypointStatus>();
    BT::RegisterJsonDefinition<std::vector<hm_nav2_msgs::msg::WaypointStatus>>();
    ...
    return providedBasicPorts(
      {
        ...
        BT::InputPort<std::vector<hm_nav2_msgs::msg::WaypointStatus>>("input_waypoint_statuses",
          "Original waypoint_statuses to mark waypoint status from"),
        BT::OutputPort<std::vector<hm_nav2_msgs::msg::WaypointStatus>>("output_waypoint_statuses",
