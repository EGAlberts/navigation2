...
/**
 * @brief A nav2_behavior_tree_humble_main::BtActionNode class that wraps nav2_msgs::action::SmoothPath
 */
class SmoothPathAction : public nav2_behavior_tree_humble_main::BtActionNode<nav2_msgs::action::SmoothPath>
{
...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::SmoothPathAction
