...
/**
 * @brief A nav2_behavior_tree_humble_main::BtActionNode class that wraps nav2_msgs::action::Wait
 */
class SpinCancel : public BtCancelActionNode<nav2_msgs::action::Spin>
{
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::WaitAction
