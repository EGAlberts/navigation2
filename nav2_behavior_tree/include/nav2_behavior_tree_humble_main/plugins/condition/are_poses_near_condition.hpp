...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::ArePosesNearCondition
  ...
  /**
   * @brief A destructor for nav2_behavior_tree_humble_main::ArePosesNearCondition
   */
