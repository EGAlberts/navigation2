...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::IsStoppedCondition
  ...
  /**
   * @brief A destructor for nav2_behavior_tree_humble_main::IsStoppedCondition
   */
...
private:
  ...
  std::shared_ptr<hm_nav2_util::OdomSmoother> odom_smoother_;
};
