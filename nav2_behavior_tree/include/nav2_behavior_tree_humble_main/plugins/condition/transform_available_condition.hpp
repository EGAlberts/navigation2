...
public:
  /**
   * @brief A constructor for nav2_behavior_tree_humble_main::TransformAvailableCondition
  ...
  /**
   * @brief A destructor for nav2_behavior_tree_humble_main::TransformAvailableCondition
   */
  ~TransformAvailableCondition();
