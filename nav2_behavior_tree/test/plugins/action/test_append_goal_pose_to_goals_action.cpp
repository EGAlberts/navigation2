...
public:
  static void SetUpTestCase()
  {
    ...
    BT::NodeBuilder builder =
      ...
      {
        return std::make_unique<nav2_behavior_tree_humble_main::AppendGoalPoseToGoals>(
          name, config);
      };

    factory_->registerBuilder<nav2_behavior_tree_humble_main::AppendGoalPoseToGoals>(
