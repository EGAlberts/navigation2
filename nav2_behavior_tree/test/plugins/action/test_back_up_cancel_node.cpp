...
#include "nav2_behavior_tree_humble_main/plugins/action/back_up_cancel_node.hpp"
...
public:
  static void SetUpTestCase()
  {
    ...
    BT::NodeBuilder builder =
      ...
      {
        return std::make_unique<nav2_behavior_tree_humble_main::BackUpCancel>(
          name, "back_up", config);
      };

    factory_->registerBuilder<nav2_behavior_tree_humble_main::BackUpCancel>("CancelBackUp", builder);
  }
