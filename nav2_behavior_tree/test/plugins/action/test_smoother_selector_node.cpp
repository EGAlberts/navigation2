...
#include "nav2_behavior_tree_humble_main/plugins/action/smoother_selector_node.hpp"
...
public:
  static void SetUpTestCase()
  {
    ...
    BT::NodeBuilder builder = [](const std::string & name, const BT::NodeConfiguration & config) {
        return std::make_unique<nav2_behavior_tree_humble_main::SmootherSelector>(name, config);
      };

    factory_->registerBuilder<nav2_behavior_tree_humble_main::SmootherSelector>(
      "SmootherSelector",
      builder);
  }
