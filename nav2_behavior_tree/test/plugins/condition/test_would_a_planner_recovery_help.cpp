...
class WouldAPlannerRecoveryHelpFixture : public nav2_behavior_tree_humble_main::BehaviorTreeTestFixture
{
public:
  ...
  void SetUp()
  {
    ...
    factory_->registerNodeType<nav2_behavior_tree_humble_main::WouldAPlannerRecoveryHelp>(
