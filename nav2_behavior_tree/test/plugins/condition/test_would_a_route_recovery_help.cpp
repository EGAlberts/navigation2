...
#include "nav2_behavior_tree_humble_main/plugins/condition/would_a_route_recovery_help_condition.hpp"
#include "nav2_msgs/action/compute_path_to_pose.hpp"

class WouldARouteRecoveryHelpFixture : public nav2_behavior_tree_humble_main::BehaviorTreeTestFixture
{
public:
  ...
  void SetUp()
  {
    ...
    factory_->registerNodeType<nav2_behavior_tree_humble_main::WouldARouteRecoveryHelp>(
