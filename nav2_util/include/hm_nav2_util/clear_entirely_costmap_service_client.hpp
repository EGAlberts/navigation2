...
#include <string>
#include "hm_nav2_util/service_client.hpp"
...
{
/**
 * @class hm_nav2_util::ClearEntirelyCostmapServiceClient
 * @brief A service client to clear costmaps entirely
 */
class ClearEntirelyCostmapServiceClient
  : public hm_nav2_util::ServiceClient<nav2_msgs::srv::ClearEntireCostmap>
{
public:
  /**
* @brief A constructor for hm_nav2_util::ClearEntirelyCostmapServiceClient
   */
  explicit ClearEntirelyCostmapServiceClient(const std::string & service_name)
  : hm_nav2_util::ServiceClient<nav2_msgs::srv::ClearEntireCostmap>(service_name)
  {
  }

  using clearEntirelyCostmapServiceRequest =
    hm_nav2_util::ServiceClient<nav2_msgs::srv::ClearEntireCostmap>::RequestType;
  using clearEntirelyCostmapServiceResponse =
    hm_nav2_util::ServiceClient<nav2_msgs::srv::ClearEntireCostmap>::ResponseType;
};
