...
/**
 * @class hm_nav2_util::LifecycleNode
...
public:
   ...
   */
  std::shared_ptr<hm_nav2_util::LifecycleNode> shared_from_this()
  {
    return std::static_pointer_cast<hm_nav2_util::LifecycleNode>(
   ...
   */
  hm_nav2_util::CallbackReturn on_error(const rclcpp_lifecycle::State & /*state*/)
  {
    RCLCPP_FATAL(
      get_logger(),
