...
/**
 * @class hm_nav2_util::SimpleActionServer
...
public:
    ...
    spin_thread_(spin_thread)
  {
    ...
    if (spin_thread_) {
      ...
      executor_thread_ = std::make_unique<hm_nav2_util::NodeThread>(executor_);
    }
  }
  ...
  void setSoftRealTimePriority()
  {
    if (use_realtime_prioritization_) {
      hm_nav2_util::setSoftRealTimePriority();
...
protected:
  ...
  std::unique_ptr<hm_nav2_util::NodeThread> executor_thread_;
