...
#include "hm_nav2_util/validate_messages.hpp"

TEST(ValidateMessagesTest, DoubleValueCheck) {
  // Test valid double value
  EXPECT_TRUE(hm_nav2_util::validateMsg(3.14));
  // Test invalid double value (infinity)
  EXPECT_FALSE(hm_nav2_util::validateMsg(std::numeric_limits<double>::infinity()));
  // Test invalid double value (NaN)
  EXPECT_FALSE(hm_nav2_util::validateMsg(std::numeric_limits<double>::quiet_NaN()));
}
...
TEST(ValidateMessagesTest, TimeStampCheck)
{
  ...
  EXPECT_TRUE(hm_nav2_util::validateMsg(valid_time_stamp));
  ...
  EXPECT_FALSE(hm_nav2_util::validateMsg(invalid_time_stamp));
}
...
TEST(ValidateMessagesTest, HeaderCheck)
{
  ...
  EXPECT_TRUE(hm_nav2_util::validateMsg(valid_header));
  ...
  EXPECT_FALSE(hm_nav2_util::validateMsg(invalid_header));
  invalid_header.stamp.sec = 123;
...
TEST(ValidateMessagesTest, PointCheck)
{
  ...
  valid_point.y = 2.0;
  valid_point.z = 3.0;
  EXPECT_TRUE(hm_nav2_util::validateMsg(valid_point));
  ...
  invalid_point.z = 3.0;
  EXPECT_FALSE(hm_nav2_util::validateMsg(invalid_point));
  // Test invalid Point message with NaN value
...
TEST(ValidateMessagesTest, QuaternionCheck)
{
  ...
  EXPECT_TRUE(hm_nav2_util::validateMsg(valid_quaternion));
  ...
  EXPECT_FALSE(hm_nav2_util::validateMsg(invalid_quaternion));
...
TEST(ValidateMessagesTest, PoseCheck)
{
  ...
  EXPECT_TRUE(hm_nav2_util::validateMsg(valid_pose));
  ...
  EXPECT_FALSE(hm_nav2_util::validateMsg(invalid_pose));
...
TEST(ValidateMessagesTest, MapMetaDataCheck) {
  ...
  EXPECT_TRUE(hm_nav2_util::validateMsg(valid_map_meta_data));
  ...
  EXPECT_FALSE(hm_nav2_util::validateMsg(invalid_map_meta_data));
...
TEST(ValidateMessagesTest, OccupancyGridCheck) {
  ...
  EXPECT_TRUE(hm_nav2_util::validateMsg(valid_occupancy_grid));
  ...
  EXPECT_FALSE(hm_nav2_util::validateMsg(invalid_occupancy_grid));
...
TEST(ValidateMessagesTest, PoseWithCovarianceCheck) {
  ...
  EXPECT_TRUE(hm_nav2_util::validateMsg(validate_msg));
  ...
  EXPECT_FALSE(hm_nav2_util::validateMsg(invalidate_msg1));
  ...
  EXPECT_FALSE(hm_nav2_util::validateMsg(invalidate_msg2));
}
